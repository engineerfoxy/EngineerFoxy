# 💫 About Me:
😊I'm a student for that wanted to learn more science and make human life's better.<br><br>🤚another point is creativity, in coding, in experience, in life, in painting and etc...<br><br>🧑‍💻what languages I'm working? there are C++, Python. and some little like PHP and Java and JS are another option :)<br><br>🦊fun fact: do you know, most of furries are working in IT industry?
